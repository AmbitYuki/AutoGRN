...
if __name__ == '__main__':
    ...
    parser.add_argument('--sensor_ids_filename', type=str, default='D:\Desktop\qjh\GTS-change\data\pjm_graph\id_aep5.txt',
                        help='File containing sensor ids separated by comma.')
    parser.add_argument('--distances_filename', type=str, default='D:\Desktop\qjh\GTS-change\data\pjm_graph\distances_aep5_1.csv',
    ...
    parser.add_argument('--output_pkl_filename', type=str, default='D:\Desktop\qjh\GTS-change\data\pjm_graph/adj_pjm_aep5_1.pkl',
